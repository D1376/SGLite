#pragma once
// Shared CUDA-side helpers: runtime checks, launch wrappers, pointer arithmetic,
// and small device utilities used by the JIT kernels.
...
// Keep pointer arithmetic centralized and restricted to void* buffers.
