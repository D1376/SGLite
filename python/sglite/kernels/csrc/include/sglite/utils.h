#pragma once
// Shared host-side utilities: source-location-aware runtime checks, panic helpers,
// and pointer arithmetic used by both C++ validation code and CUDA launchers.

// NVCC 12.1 source_location workaround:
