"""Low-level indexing helpers backed by compiled kernels."""
...
def _jit_index_module(
    ...
    *,
    ...
    """Compile or fetch the indexing kernel for one element size."""
...
def indexing(
    ...
    *,
    ...
    """Index into the source tensor using the provided mapping."""
    if output is None:
