...
def _serialize_any(value: Any) -> Any:
    """Recursively convert nested message fields into transport-safe values."""
...
def serialize_type(self) -> Dict:
    """Serialize a dataclass-like message into msgpack bytes."""
    serialized = {}
...
def _deserialize_any(cls_map: Dict[str, Type], data: Any) -> Any:
    """Recursively restore nested transport values into message fields."""
...
def deserialize_type(cls_map: Dict[str, Type], data: Dict) -> Any:
    """Deserialize msgpack bytes into the requested message type."""
