"""Mixture-of-experts layer wiring."""
...
class MoELayer(BaseModule):
    """Mixture-of-experts layer that dispatches tokens through the active backend."""
    def __init__(
        self,
        num_experts: int,
        top_k: int,
        ...
        """Allocate expert weights and tensor-parallel communication state."""
        super().__init__()
    ...
    def forward(self, hidden_states: torch.Tensor, router_logits: torch.Tensor):
        """Dispatch tokens through experts and reduce outputs across ranks."""
        ctx = get_global_ctx()
