...
from sglite.benchmark.perf import compare_memory_kernel_perf
from sglite.kernels import indexing
from sglite.srt.utils import init_logger

logger = init_logger(__name__)
pytestmark = pytest.mark.skipif(not torch.cuda.is_available(), reason="CUDA is required for kernel tests")
